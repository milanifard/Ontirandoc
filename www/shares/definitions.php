...
//    define("C_TIME","Time");
   ...
   // define("C_ARE_YOU_SURE","Are You Sure?");
    ...
    define("C_STRUCTURAL_SIMILARITY","Structural similarity");
    define("C_PEERS_IN_THE_SEMANTIC_NETWORK","Peers in the semantic network");
    define("C_MORE_SPECIFIC_MEANING_IN_THE_SEMANTIC_GRID","More specific meaning in the semantic grid");
    define("C_MORE_GENERAL_MEANING_IN_THE_SEMANTIC_GRID","More general meaning in the semantic grid");
    define("C_PERIODICITY","periodicity");
    define("C_WORD","Word ");
    define("C_RECORDER","Recorder ");
    define("C_REFERENCES_IN_WORDS","References");
    define("C_WORD_CODE","Code");
    define("C_SIMILARITY_TYPE","Similarity type");
    define("C_RESOURCES_AND_THE_NUMBER_OF_REPETITIONS","Resources and the number of repetitions");
    define("C_REPLACEMENT","Replacement");
    define("C_REPLACE_THE_SELECTED_WORD_WITH_THE_WORD_IN_THIS_ROW","Replace the selected word with the word in this row");
    define("C_CREATE_EDIT_TERMS","Create / edit terms");
    define("C_NOTE","Note");
    define("C_MERGE_SUGGESTIONS","Merge suggestions");
    define("C_CREATION_TIME","Creation time");
    define("C_ONTOLOGY_ELEMENT","Ontology element");
    define("C_RECORD","Record");
    define("C_SUMMARY_OF_INFORMATION","Summary of information");
    define("C_MAPPING_OF_IDIOMS_AND_ELEMENTS_OF_HISTOGRAM","Mapping of idioms and elements of ontology");
...
//    define("C_TIME","زمان");
    ...
    define("C_STRUCTURAL_SIMILARITY","شباهت ساختاری");
    define("C_PEERS_IN_THE_SEMANTIC_NETWORK","همرده در شبکه معنایی");
    define("C_MORE_SPECIFIC_MEANING_IN_THE_SEMANTIC_GRID","معنای خاص تر در شبکه معنایی");
    define("C_MORE_GENERAL_MEANING_IN_THE_SEMANTIC_GRID","معنای عام تر در شبکه معنایی");
    define("C_PERIODICITY","تناوب");
    define("C_WORD","واژه : ");
    define("C_RECORDER","ثبت کننده : ");
    define("C_REFERENCES_IN_WORDS","ارجاعات: ");
    define("C_WORD_CODE","کد");
    define("C_SIMILARITY_TYPE","نوع شباهت");
    define("C_RESOURCES_AND_THE_NUMBER_OF_REPETITIONS","منابع و تعداد تکرار");
    define("C_REPLACEMENT","جایگزینی");
    define("C_REPLACE_THE_SELECTED_WORD_WITH_THE_WORD_IN_THIS_ROW","واژه انتخابی با واژه این ردیف جایگزین شود");
    define("C_CREATE_EDIT_TERMS","ایجاد/ویرایش اصطلاحات");
    define("C_NOTE","یادداشت");
    define("C_MERGE_SUGGESTIONS","پیشنهادات ادغام");
    define("C_CREATION_TIME","زمان ایجاد");
    define("C_ONTOLOGY_ELEMENT","عنصر هستان نگار");
    define("C_RECORD","ثبت");
    define("C_SUMMARY_OF_INFORMATION","خلاصه اطلاعات");
    define("C_MAPPING_OF_IDIOMS_AND_ELEMENTS_OF_HISTOGRAM","نگاشت اصطلاحات و عناصر هستان نگار");
