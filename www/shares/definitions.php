...
//    PrintPageHelper.php by Yegane Shabgard
    ...
    //LastDonTasks.php, ManageOntologyMergeProject.php ,ManageOntologyClassParents.php by Hannaneh Shirzadnia
    define("C_DATE_OF_LAST_ACTION","Date of last action");
    define("C_TIME_TO_DO","Time to do");
    define("C_PARENTS_CLASS","parents class");
    define("C_PARENT_CLASS","parents class");
...
//   NewFile.php by Yegane Shabgard
    ...
    //LastDonTasks.php, ManageOntologyMergeProject.php ,ManageOntologyClassParents.php by Hannaneh Shirzadnia
    define("C_DATE_OF_LAST_ACTION","تاریخ آخرین اقدام");
    define("C_TIME_TO_DO","زمان انجام");
    define("C_PARENTS_CLASS","کلاس های پدر");
