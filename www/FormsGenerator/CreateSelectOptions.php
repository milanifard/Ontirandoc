...
<tr class=HeaderOfTable><td align=center>ایجاد/ویرایش آیتمهای لیست برای فیلدهای از نوع لیستی</td></tr>
<tr><td>
...
echo "<br>";
$CopyOption = "";
$res = $mysql->Execute("select FormFieldID, substring(FieldTitle, 1, 80) as FieldTitle from FormFields where FieldType=3 and CreatingListType='STATIC_LIST' order by FormFieldID DESC");
while($rec = $res->FetchRow())
{
...
if($CopyOption!="")
{
	...
	echo "کپی آیتمهای از لیست مربوط به فیلد ";
