...
<tr>
	<td class=HeaderOfTable align=center>راهنمای تولید صفحه جستجوی مقادیر </td>
</tr>
<tr>
	<td>
	بعضی از مواقع داده هایی که در یک فیلد لیستی قابل انتخاب هستند بسیاز زیاد بوده و نمایش آنها به صورت لیست کشویی علاوه بر اینکه حجم زیادی
	...
	<br>
	در این حالت در فرم ورود داده در جلوی نام این فیلد یک لینک برای انتخاب داده مورد نظر نمایش داده می شود که کاربر بتواند با کلیک روی آن
	در صفحه ای که در یک پنجره جداگانه باز می شود به جستجوی آیتم مورد نظر خود پرداخته و آن را انتخاب کند تا در مقدار فیلد قرار گیرد.
	<br>
	...
	<li>InputName: نام عنصری که داخل فرم به صورت مخفی قرار دارد و باید مقدار کلید آیتم انتخاب شده در آن قرار گیرد
	...
	<br>
	حال باید برنامه نویس در کد خود زمانیکه کاربر آیتم مورد نظر را انتخاب کرد یک تابع جاوا اسکریپ مشابه این را فراخوانی کند:
	<br>
