...
function CreateEntityMappingHeader($SourceOntologyID, $EntityType, $EntityID, $Term1, $OntologyID)
{
    ...
    if($EntityType=="CLASS")
        $HeaderOfTable .=  C_CLASS;
    if($EntityType=="PROPERTY")
        $HeaderOfTable .=  C_PROPERTICE;
...
/*
echo "<form class='form-group' method=post id=f1 name=f1>";
    echo "<div class='container'>";
        echo "<div class='row border border-dark'>";
            echo "<div class='col-12'>";
                echo "<div class='row'>";
                    echo "<p class='col-12 bg-info text-dark text-center'>";
                        echo C_COMPAIRE_ONTOLOGIES;
                    echo "</p>";
                echo "</div>";
                echo "<div class='row'>";
                    echo "<p class='col-12 text-dark text-left'>";
                ...
                echo "<div class='row'>";
                    echo "<p class='col-12 text-dark text-left'>";
                        echo "<div class='custom-checkbox'>";
                            echo "<label> <input type='checkbox'> نگاشت از پیش موجود پاک شود </label> ";
                        echo "</div>";
                    echo "</p>";
                echo "</div>";
                echo "<div class='row-cols-12  text-center bg-info bottom-table'>";

                        echo "<input type='submit'value='انجام نگاشت نیمه خودکار'>";

                        echo " <input type='submit' value='نمایش نتایج مقایسه' onclick='javascript: ShowResult()'>";

                        echo " <input type='submit' value='اعمال تعدی و تقارنی' onclick='ApplyTransitive_Symmetry()'>";
                        echo "<label><button type=\"submit\" class=\"btn btn-default\"></button></label>>";
...
echo "<input type=submit value='انجام نگاشت نیمه خودکار'>";
echo " <input type=submit value='نمایش نتایج مقایسه' onclick='javascript: ShowResult()'>";
echo " <input type=submit value='اعمال تعدی و تقارنی' onclick='javascript: ApplyTransitive_Symmetry()'>";
...
<html>
<form class="form-group" method=post id=f1 name=f1>
    <input class="form-control" type=hidden name=ActionType id=ActionType value='MAPPING'>
    <div class='container'>
        <div class='row border border-dark'>
            <div class='col-12'>
                <div class='row'>
                    <p class='col-12 bg-info text-dark text-center'>
                        <?php echo C_COMPAIRE_ONTOLOGIES; ?>
                    </p>
                </div>
                <div class='row'>
                    <p class='col-12 bg-success text-light'>
                    <td><?php echo C_COMPARE_THE_ELEMENT; ?>
                        <select name=OntologyID1 dir=ltr>
                            <?php echo $OntologyList; ?>

                        </select>  <?php echo C_WITH; ?>
                        <select  name=OntologyID2 dir=ltr>;
                            <?php echo $OntologyList; ?>
                        </select>
                    </p>
                </div>
                <div class='row'>
                    <p class='col-12 text-dark text-left'>
                    <div class='col-12 bg-success text-light '>
                        <label> <input  type='checkbox'> <?php echo C_CLEAR_PRE_EXITING_MAPPING; ?> </label>
                    </div>
                    </p>
                </div>

                <div class='row-cols-12  text-center bg-info bottom-table'>


                    <input class="col-3 btn btn-dark" type="submit" value="<?php echo C_SEMI_AUTOMATED_MAPPING; ?>">
                    <input class="col-3 btn btn-dark" type="submit" value="<?php echo C_SHOWING_COMPARISON_RESULTS; ?>" onclick='javascript: ShowResult()'>
                    <input class="col-3 btn btn-dark" type="submit" value=" <?php echo C_ABUSES_AND_SYMMETRIES; ?>" onclick='javascript: ApplyTransitive_Symmetry()'>
