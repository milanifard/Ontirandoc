...
<td align="center">ایجاد/ویرایش انواع اقدامات</td>
</tr>
<tr>
<td>
...
<? } ?>
 <input type="button" onclick="javascript: document.location='ManageProjectTaskActivityTypes.php?ProjectID=<?php echo $_REQUEST["ProjectID"]; ?>'" value="جدید">
</td>
</tr>
</table>
...
<tr class="HeaderOfTable">
	...
	<td>عنوان</td>
	<td width=1% nowrap>تعداد اقدام</td>
</tr>
<?
for($k=0; $k<count($res); $k++)
{
