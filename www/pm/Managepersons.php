...
<tr>
 ...
 ایمیل
	...
	<td nowrap>
	<input type="text" name="Item_CardNumber" id="Item_CardNumber" maxlength="45" size="40" dir=ltr>
	</td>
</tr>
<tr>
	<td width="1%" nowrap>
...
<tr>
 ...
 حساب بانکی
	...
	<td nowrap>
	<input type="text" name="Item_AccountInfo" id="Item_AccountInfo" maxlength="500" size="40" dir=rtl>
	</td>
</tr>
<tr>
	<td width="1%" nowrap>
...
<input type="button" onclick="javascript: ValidateForm();" value="ذخیره">
 <input type="button" onclick="javascript: document.location='Managepersons.php';" value="جدید">
</td>
</tr>
</table>
