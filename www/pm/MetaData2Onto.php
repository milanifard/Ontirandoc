                ...
                <div class="col-12">
                    <div class="row">
                        <p class="col-12 bg-info text-dark text-center  ">
                            <?php
                            echo C_CHOOSE_CONDITIONS_FOR_REVERSE_ENGINEERING;
                            ?>
                        </p>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <?php echo C_INTENDED_SCOPES; ?>:
                            <br>
                            <input type="checkbox" id="ch_educ" name="ch_educ">
                            <?php echo C_EDUCATIONAL; ?>
                            <br>
                            <input type="checkbox" id="ch_research" name="ch_research">
                            <?php echo C_RESEARCH; ?>
                            <br>
                            <input type="checkbox" id="ch_student" name="ch_student">
                            <?php echo C_STUDENT_SERVICES . ' (' . C_WELFARE . ' - ' . C_FINANCIAL . ')'; ?>
                            <br>
                            <input type="checkbox" id="ch_support" name="ch_support">
                            <?php echo C_SUPPORT . ' (' . C_ADMINISTRATIVE . ' / ' . C_FINANCIAL . ')'; ?>
                            <br>
                            <input type="checkbox" id="ch_system" name="ch_system">
                            <?php echo C_RELATED_TO_SYSTEM_OPERATIONS; ?>
                        ...
                        <div class="col-6">
                            ...
                            <div style="margin-top:2%;">
                                ...
                                <input type="checkbox" name="ch_RemovePMS" id="ch_RemovePMS" class="custom-checkbox"
                                       checked>
                                <?php echo C_REMOVE_PREVIOUS_MERGE_SUGGESTIONS; ?>
                                <br>
                                <input type="checkbox" name="ch_RemovePD" id="ch_RemovePD" class="custom-checkbox"
                                       checked>
                                <?php echo C_REMOVE_EXISTING_ELEMENTS_OF_ONTOLOGY; ?>
                                <br>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 bg-info text-center">
                            <input class="btn btn-dark" type="submit"
                                   style="margin:1% 5px;"
                                   value='<?php echo C_PERFORM_REVERSE_ENGINEERING; ?>'>

                            <input class="btn btn-dark"
                                   style="margin:1% 5px;"
                                   type="button" value='<?php echo C_REVIEW_PROPERTIES_MERGING_SUGGESTIONS; ?>'
                                   onclick='window.open("OntologyMergeProperties.php?TargetOnto="+document.getElementById("TargetOnto").value);'>
