...
<tr class="HeaderOfTable">
	...
	<td nowrap width=1%><a href="javascript: Sort('LastActivityDate', 'ASC');">تاریخ آخرین اقدام</a></td>
	<td nowrap width=1%><a href="javascript: Sort('DoneDate', 'ASC');">زمان انجام</a></td>
	<td nowrap width=1%>
	سایر مشخصات
	</td>
</tr>
