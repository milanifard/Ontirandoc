...
function ShowClassMergeSuggestions($TargetOnto)
{
    ...
    while ($rec = $res->fetch()) {
        ...
        echo "<option value='1'>" . C_ONT_MERG_CLASSES_PAGE_OFIR . ": " . $rec["ExtraInfo"];
        echo "<option value='2'>" . $rec["ClassLabel2"] . " " . C_ONT_MERG_CLASSES_PAGE_OSEC . " " . $rec["ClassLabel1"] . " " . C_ONT_MERG_CLASSES_PAGE_OTIR . "";
        echo "<option value='4'>" . $rec["ClassLabel1"] . " " . C_ONT_MERG_CLASSES_PAGE_OSEC . " " . $rec["ClassLabel2"] . " " . C_ONT_MERG_CLASSES_PAGE_OTIR . "";
        echo "<option value='3'>" . $rec["ClassLabel2"] . " " . C_ONT_MERG_CLASSES_PAGE_OFOR . " " . $rec["ClassLabel1"] . " " . C_ONT_MERG_CLASSES_PAGE_OFIF . "";
        echo "<option value='5'>" . $rec["ClassLabel1"] . " " . C_ONT_MERG_CLASSES_PAGE_OFOR . " " . $rec["ClassLabel2"] . " " . C_ONT_MERG_CLASSES_PAGE_OFIF . "";
        echo "</select></td>";
        echo "</tr>";
    }
}
...
<div class="container container-fluid">
    <div class="card">
        <div class="card-header" style="text-align: center">
            <?php echo C_ONT_MERG_CLASSES_PAGE_CH ?>
        </div>
        <div class="card-body">
            <form method=post>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <table class="table table-striped">
                            <tr>
                                <th><?php echo C_ONT_MERG_CLASSES_PAGE_CH ?></th>
                                <th><?php echo C_ONT_MERG_CLASSES_PAGE_CBSEC ?> 1</th>
                                <th><?php echo C_ONT_MERG_CLASSES_PAGE_CBTIR ?> 1</th>
                                <th><?php echo C_ONT_MERG_CLASSES_PAGE_CBSEC ?> 2</th>
                                <th><?php echo C_ONT_MERG_CLASSES_PAGE_CBFOR ?></th>
                                <th><?php echo C_ONT_MERG_CLASSES_PAGE_CBTIR ?> 2</th>
                            </tr>
                ...
                <div class="row">
                    <div class="col" style="text-align: center">
                        <input class="btn btn-primary" type=submit
                               value='<?php echo C_ONT_MERG_CLASSES_PAGE_CBFIF ?>'>
                    </div>
                </div>
